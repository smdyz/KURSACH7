    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='Телеграмм чат айди')),
                ('telegram_nik', models.CharField(max_length=50, verbose_name='Телеграм ник')),
                ('ver_code', models.CharField(blank=True, help_text='Код верификации', max_length=4, null=True, verbose_name='Код верификации')),
